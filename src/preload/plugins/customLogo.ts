...
/** 把当前选项实时上到真实 #tb-logo。
 *  [网页版适配] 桌面由 titlebar 注入并 4s 守护；网页端无 titlebar → 本模块自建同款宿主
